    ...
    const handleMaskFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        img.onload = () => {
            if (img.width !== editOriginalImageSize.width || img.height !== editOriginalImageSize.height) {
                alert(
                    `遮罩尺寸 (${img.width}x${img.height}) 必须与源图像尺寸 (${editOriginalImageSize.width}x${editOriginalImageSize.height}) 匹配。`
                );
            ...
            <form onSubmit={handleSubmit} className='flex h-full flex-1 flex-col overflow-hidden'>
                <CardContent className='flex-1 space-y-5 overflow-y-auto p-4'>
                    ...
                    <div className='space-y-2'>
                        <Label className='text-white'>源图像 [最多: 10]</Label>
                        <Label
                        ...
                        {editShowMaskEditor && firstImagePreviewUrl && editOriginalImageSize && (
                            <div className='space-y-3 rounded-md border border-white/20 bg-black p-3'>
                                <p className='text-xs text-white/60'>
                                    在下面的图像上绘制以标记要编辑的区域（绘制的区域在遮罩中变为透明）。
                                </p>
                                <div
                                ...
                                <div className='flex items-center justify-between gap-2 pt-3'>
                                    ...
                                    <div className='flex gap-2'>
                                        ...
                                        <Button
                                            ...
                                            className='bg-[#ffc107] text-black hover:bg-[#ffc107]/90 disabled:opacity-50'>
                                ...
                                {editIsMaskSaved && editMaskPreviewUrl && (
                                    <p className='pt-1 text-center text-xs text-green-400'>遮罩保存成功！</p>
                                )}
                            </div>
                        )}
                    ...
                    <div className='w-full space-y-3'>
                        ...
                        <div className='flex items-center justify-between text-sm text-white/70'>
                            ...
                            <span className='font-medium text-blue-400'>
                                {formatPointsDisplay(calculatePointsFromFormData({
                                    prompt: editPrompt,
                                    n: editN[0],
                                    size: editSize,
                                    quality: editQuality,
                        ...
                        <Button
                            ...
                            className='flex w-full items-center justify-center gap-2 rounded-md bg-[#ffc107] text-black hover:bg-[#ffc107]/90 disabled:bg-white/10 disabled:text-white/40'>
